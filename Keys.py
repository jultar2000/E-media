...
from PrimeNumGenerator import PrimeNumGenerator
...
class Keys:
    ...
    def __init__(self, key_size=1024):
        ...
        self.p = PrimeNumGenerator.generate_prime_number(key_size)
        self.q = PrimeNumGenerator.generate_prime_number(key_size)
